...
import Tablenilaimakanan from '@/Components/Admin/Tablenilaimakananahp';
            ...
            <div className="min-h-screen bg-slate-50">
                ...
                <div className="container py-12 max-w-7xl mx-auto sm:px-6 lg:px-56">
                    <div className="btn-group btn-group-vertical lg:btn-group-horizontal left-0">
                            <h1 href="#">Nilai Makanan Rekomendasi AHP</h1>
                        </div>
                    ...
                    <Tablenilaimakanan nilaialts={props.nilaialts} />
                </div>
